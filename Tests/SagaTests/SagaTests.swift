...
final class SagaTests: XCTestCase, @unchecked Sendable {
  ...
  func testCreatePageForEachLocale() async throws {
    ...
    XCTAssertTrue(enHome!.content.hasPrefix("en:2:"))
    ...
    XCTAssertTrue(nlHome!.content.hasPrefix("nl:1:"))

    // Both should have translations pointing to each other
    XCTAssertTrue(enHome!.content.contains("en:/"))
    XCTAssertTrue(enHome!.content.contains("nl:/nl/"))
    XCTAssertTrue(nlHome!.content.contains("en:/"))
    XCTAssertTrue(nlHome!.content.contains("nl:/nl/"))
  }
