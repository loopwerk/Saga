...
## Ignoring files during dev rebuilds

Files generated by your own build steps can trigger another rebuild, causing a loop. Use ``Saga/ignoreChanges(_:)`` to exclude them, passing a glob pattern. Call it once per pattern:
